...
// let cursor = 'eyJzIjoxMDAsImQiOmZhbHNlLCJ0Ijp0cnVlfQ=='

  
export async function getGamesPerPage(number) {//20 games per page
...
// export const getGamesTwitch = async () => {
//   try {

//     const token_twitch = localStorage.getItem('token_twitch')

//     // const response = await fetch(`https://api.twitch.tv/helix/games?id=20`, {
//       const response = await fetch(`https://api.twitch.tv/helix/games/top?first=100${cursor ? `&after=${cursor}` : ''}`, {
//       headers: {
//         'Client-ID': client_id,
