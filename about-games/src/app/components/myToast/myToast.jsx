  ...
  return(
    <div className={'toast-wrapper ' + toastType[type]?.border + (isOpen ?' show-toast' : '')} >
      <section className='toast-close-button' title='Close'>
        <svg xmlns="http://www.w3.org/2000/svg" width={widthIcon-14} height={heightIcon-14} fill="currentColor" className="bi bi-x" viewBox="0 0 16 16"> 
      ...
      <section className='toast-content'>
        <i className='toast-icon'>
          <svg xmlns="http://www.w3.org/2000/svg" fill={toastType[type]?.color} width={widthIcon} height={heightIcon} viewBox="0 0 24 24">
